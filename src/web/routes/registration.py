...
from ...config.settings import Settings, get_settings, normalize_proxy_assignment_strategy
...
def _build_email_service_for_task(
    ...
    if service_type == EmailServiceType.CLOUDMAIL:
        db_service = db.query(EmailServiceModel).filter(
                            ...
                            for _sid in _s2a_ids:
                                try:
                                    ...
                                    if _ok:
                                        ...
                                        saved_account.sub2api_uploaded_at = utcnow_naive()
                                        db.commit()
                            ...
                            for _sid in _tm_ids:
                                try:
                                    ...
                                    if _ok:
                                        ...
                                        saved_account.tm_uploaded_at = utcnow_naive()
                                        db.commit()
